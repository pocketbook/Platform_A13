...
typedef struct
{
    ...
    __bool                  lcd_eink_main_pwr_used;
    user_gpio_set_t         lcd_eink_main_pwr;

    __bool                  lcd_eink_vneg_used;
    user_gpio_set_t         lcd_eink_vneg;

    __bool                  lcd_eink_vpos_used;
    user_gpio_set_t         lcd_eink_vpos;

    __bool                  lcd_eink_ud_used;
    user_gpio_set_t         lcd_eink_ud;

    __bool                  lcd_eink_rl_used;
    user_gpio_set_t         lcd_eink_rl;

    __bool                  lcd_eink_vgg_used;
    user_gpio_set_t         lcd_eink_vgg;

    __bool                  lcd_eink_vcom_used;
    user_gpio_set_t         lcd_eink_vcom;
}__disp_lcd_cfg_t;
...
{    
    ...
    wait_queue_head_t       screen_queue;
    __bool                  b_screen_finished;
#endif
