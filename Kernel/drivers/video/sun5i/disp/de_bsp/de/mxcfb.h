...
// To satisfy IOCTL sanity checker
...
#define MXCFB_GET_TEMP_RANGES		_IOR('F', 0x71, void *)
#define MXCFB_READ_WAVEFORM		_IOR('F', 0x72, void *)
#define MXCFB_WRITE_WAVEFORM		_IOW('F', 0x73, void *)
