...
static void ((*direct_callback[16])(void));
...
void sw_dma_set_direct_callback(int ch, void (*fn)(void))
{
	direct_callback[ch] = fn;
}
EXPORT_SYMBOL(sw_dma_set_direct_callback);
