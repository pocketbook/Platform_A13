...
//==============================================================================
// TOUCH CHECK FOR SYSTEM STANDBY
//==============================================================================
...
*                           standby_touch_init
*
* Description: init touch for standby.
*
* Arguments  : none;
*
* Returns    : result;
*********************************************************************************************************
*/
__s32 standby_touch_init(__u32 wakeup_src)
{
	__u8	reg_val;

	standby_twi_init(TP_IICBUS);

	twi_byte_rw(TWI_OP_RD, TP_IICBUS, );
...
*                           standby_touch_exit
*
* Description: exit touch for standby.
*
* Arguments  : none;
*
* Returns    : result;
*********************************************************************************************************
*/
__s32 standby_touch_exit(__u32 wakeup_src)
{
	__u8    reg_val;
...
static struct axp_info axp20_info[] = {
	AXP(TOUCH_VOL_LDO1,	 AXP20LDO1,	AXP20LDO1,	  0, AXP20_LDO1,  0, 0),//ldo1 for rtc
	AXP(TOUCH_VOL_LDO2,	      1800,      3300,  100, AXP20_LDO2,  4, 4),//ldo2 for analog1
	AXP(TOUCH_VOL_LDO3,	       700,      3500,   25, AXP20_LDO3,  0, 7),//ldo3 for digital
	AXP(TOUCH_VOL_LDO4,	      1250,      3300,  100, AXP20_LDO4,  0, 4),//ldo4 for analog2
	AXP(TOUCH_VOL_DCDC2,       700,      2275,   25, AXP20_BUCK2, 0, 6),//buck2 for core
	AXP(TOUCH_VOL_DCDC3,       700,      3500,   25, AXP20_BUCK3, 0, 7),//buck3 for memery
};
...
*
*Arguments  : type      voltage type, defined as "enum touch_vol_type_e";
...
*********************************************************************************************************
*/
void  standby_set_voltage(enum touch_vol_type_e type, __s32 voltage)
{
...
*********************************************************************************************************
*/
__u32 standby_get_voltage(enum touch_vol_type_e type)
{
	struct axp_info *info = 0;
	__u8 val, mask;
